...
include 'sidebar.php';
    ...
    if($_SERVER['REQUEST_METHOD']=='POST') {
        if ($_POST['form_name']=='delete_subscriber') {
            $id = $_POST['subscriber_id'];
            $subscriber->n_sub_id = $id;
            if ($subscriber->delete()) {
                $flag = "Delete subscriber successful!";
            }
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <!-- DELETE -->
                                                    <button data-toggle="modal"  value="Delete" data-target="#delete_subscriber<?php echo $rows['n_sub_id'] ?>"
                                                     class="btn btn-danger" ><i class="fa fa-pencil"></i> Delete</button>
                                                         
                                                    
                                                        <!-- DELETE -->
                                                    <div class="modal fade" id="delete_subscriber<?php echo $rows['n_sub_id']?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                                        <div class="modal-dialog">
                                                            ...
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-footer">
                                                                    ...
                                                                    <input type="hidden" name="form_name" value="delete_subscriber">
                                                                    <input type="hidden" name="subscriber_id" value="<?php echo $rows['n_sub_id']; ?>">
